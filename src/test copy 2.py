...
model(x0)
torch_out = torch_inter_layer_in[0]    #卷积层输入，也就是shif层输出
...
layer_name = "lambda_5" #fft_shift_2d输出
...
# print("torch模型和keras模型第index:{}层输出截取：".format(pre_index),torch_out[0,1,:3,:3], keras_output_torch_tensor[0,1,:3,:3],sep="\n")
a=2
#torch的conv2d是包含偏置的。
